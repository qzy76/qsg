		...
		<div class="main">
				...
				<ol>
					...
					<li>
						<div><i class="icon iconfont qzy-jindu"></i>
							...
							<span>
								<?php
								if($email==""){echo'添加邮箱';}else{echo'修改邮箱';}
								?>
								</span>
						</div>
						<div></div>
			...
			<div class="mbuttom">
					<div class="tijiaoxiang">
						<lable class="lable" style="font-size: 20px;">密码：</lable>
						<input autocomplete="off" type="text" onfocus="this.type='password'" class="upwds" />
					</div>
