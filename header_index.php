...
//				$file = basename($path);
			...
			<div>
				<p>
				<input type="text" autofocus name="uname" class="user" placeholder="手机 / 邮箱 / 用户名" />
			</p>
			<p>
...
<div id="header" class="clearfix">
						...
						<span id="user" class="ml15">
							<?php
								...
								if($uid!=null&&$uid>0){
									...
									// echo('<a href="javascript:;" onclick="loginnow ()" class="login co pr15">请登录</a><a target="_blank" href="register.php" class="reg c666">免费注册</a>');
									echo('<a target="_blank" href="login.php" class="login co pr15">请登录</a><a target="_blank" href="register.php" class="reg c666">免费注册</a>');
								}
							?>
						</span>
			...
			<div class="hmain_center clearfix h200 pr bafff">
					...
					<div class="search_push">
						<ul class="push_pro fl tn">
							...
							<?php
								...
								pclassification = cccoid WHERE phot =1 order by rand() LIMIT 0,10";
							...
							<li class="cb">
								...
								<div class="fine_pro1">
									...
									<dd class="fl">
										...
										?>
										<a target="_blank" href="goodslist.php?class3=<?php echo($pqrow['ccconame']);?>"><?php echo($pqrow['ccconame']);?></a>
										<?php }?>
									</dd> 
									<br />
									<?php }?>
				...
				<div class="main-hnav pa mt10 bafff">
					<ul>
						<li class="fl lhh40 h40 f16 pc20"><?php if($file!="index.php"&$file!="Graduationproject"){echo '<a target="_blank" href="index.php"';}else{echo '<a ';}?>class="c666 fb tdn">首页</a></li>
						<?php
				...
				<div class="hnav_cart mt7 pa cp">
					<div class="cartlogo">
						<a
							<?php
								if($uid!=null&&$uid>0){echo(' target="_blank" href="cart.php"');}
								else{echo('onclick="loginnow ();"');}?>
							><i class="icon iconfont qzy-gouwuche"></i></a>
					</div>
					<div class="cart ba">
